...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    //初始化view刷新缓存对象
    [Constants Instance].viewrefreshCache = [[NSMutableDictionary alloc] initWithObjectsAndKeys:@YES,@"mainpage",@YES,@"newexpend",@YES,@"billpage",@YES,@"settingpage",@YES,@"chartpage", nil];
